    ...
    <section id="about" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="grid auto-rows-[minmax(0,1fr)] grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <h3 className="font-display text-2xl font-semibold">Self-taught, detail-obsessed</h3>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            I specialise in dynamic, accessible and highly responsive web experiences.
            I'm proficient in clean code management, consistently exceeding client
            expectations and integrating creative UI solutions that feel premium.
          </p>
        </motion.div>
